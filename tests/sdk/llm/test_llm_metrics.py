...
class TestCost:
    """Test cases for the Cost class."""

    def test_cost_creation_valid(self):
    ...
    def test_cost_pydantic_features(self):
...
class TestResponseLatency:
    """Test cases for the ResponseLatency class."""

    def test_response_latency_creation_valid(self):
    ...
    def test_response_latency_creation_zero(self):
    ...
    def test_response_latency_creation_negative_fails(self):
    ...
    def test_response_latency_pydantic_features(self):
        """Test Pydantic features work correctly."""
...
class TestTokenUsage:
    """Test cases for the TokenUsage class."""
    ...
    def test_token_usage_creation_zeros(self):
    ...
    def test_token_usage_negative_prompt_tokens_fails(self):
    ...
    def test_token_usage_negative_completion_tokens_fails(self):
        ...
        assert any(
            ...
            and "completion_tokens" in error["loc"]
            for error in errors
        )

    def test_token_usage_negative_cache_tokens_fails(self):
    ...
    def test_token_usage_pydantic_features(self):
        """Test Pydantic features work correctly."""
        usage = TokenUsage(
            model="gpt-3.5",
            prompt_tokens=75,
...
class TestMetrics:
    ...
    def test_metrics_creation_with_model_name(self):
    ...
    def test_metrics_add_cost(self):
    ...
    def test_metrics_add_cost_with_model_name(self):
    ...
    def test_metrics_add_multiple_costs(self):
    ...
    def test_metrics_add_response_latency(self):
    ...
    def test_metrics_add_multiple_response_latencies(self):
    ...
    def test_metrics_add_token_usage_first_time(self):
    ...
    def test_metrics_add_token_usage_accumulate(self):
    ...
    def test_metrics_merge_empty_metrics(self):
    ...
    def test_metrics_merge_with_costs(self):
    ...
    def test_metrics_merge_with_token_usage(self):
    ...
    def test_metrics_merge_with_response_latencies(self):
    ...
    def test_metrics_get_method(self):
    ...
    def test_metrics_diff_method(self):
    ...
    def test_metrics_diff_with_none_token_usage(self):
    ...
    def test_metrics_deep_copy(self):
    ...
    def test_metrics_pydantic_features(self):
        """Test Pydantic features work correctly."""
        metrics = Metrics(model_name="gpt-4")
        metrics.add_cost(5.0)
        metrics.add_token_usage(100, 50, 10, 5, 4096, "test-123")
    ...
    def test_metrics_model_validator(self):
    ...
    def test_metrics_empty_state_operations(self):
    ...
    def test_metrics_as_pydantic_field(self):
