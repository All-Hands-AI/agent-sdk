...
class TestSendMessageEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_send_message_with_run_true(self, client, sample_conversation_id, mock_event_service):
        """Test send_message endpoint with run=True."""
        with patch("openhands.agent_server.event_router.conversation_service") as mock_conv_service:
    ...
    @pytest.mark.asyncio
    async def test_send_message_with_run_false(self, client, sample_conversation_id, mock_event_service):
    ...
    @pytest.mark.asyncio
    async def test_send_message_default_run_value(self, client, sample_conversation_id, mock_event_service):
        ...
        with patch("openhands.agent_server.event_router.conversation_service") as mock_conv_service:
            ...
            assert isinstance(message, Message)
            assert message.role == "user"
            assert run_flag is True  # Default value from SendMessageRequest

    @pytest.mark.asyncio
    async def test_send_message_conversation_not_found(self, client, sample_conversation_id):
    ...
    @pytest.mark.asyncio
    async def test_send_message_with_different_content_types(self, client, sample_conversation_id, mock_event_service):
        ...
        with patch("openhands.agent_server.event_router.conversation_service") as mock_conv_service:
            ...
            assert message.content[1].text == "Second part"
            assert run_flag is False

    @pytest.mark.asyncio
    async def test_send_message_with_system_role(self, client, sample_conversation_id, mock_event_service):
    ...
    @pytest.mark.asyncio
    async def test_send_message_invalid_request_data(self, client, sample_conversation_id):
