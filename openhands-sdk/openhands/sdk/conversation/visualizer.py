...
class ConversationVisualizer:
    ...
    def __init__(
        ...
        """
        self._console: Console = Console()
        self._skip_user_messages: bool = skip_user_messages
        base_patterns = dict(DEFAULT_HIGHLIGHT_REGEX)
        if highlight_regex:
            base_patterns.update(highlight_regex)
        self._highlight_patterns: dict[str, str] = base_patterns
        self._conversation_stats: ConversationStats | None = conversation_stats
